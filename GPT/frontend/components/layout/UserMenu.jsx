    ...
    <>
      <div className="relative" ref={menuRef}>
        ...
        >
          ...
          {/* Dropdown icon */}
          <ChevronDown
            className={`w-4 h-4 text-dark-textSecondary transition-transform ${isOpen ? 'rotate-180' : ''
              }`}
          />
        </button>
        ...
        {/* Dropdown menu */}
        {isOpen && (
          <div className="absolute right-0 mt-2 w-64 bg-dark-bgSecondary rounded-xl shadow-2xl border border-dark-border py-2 animate-fade-in z-50">
            {/* User info */}
            ...
            <div className="py-1">
              ...
              <button
                ...
                className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-dark-text hover:bg-dark-bgTertiary transition-colors"
              >
                <KeyRound className="w-4 h-4 text-dark-textSecondary" />
                API Keys
              </button>
