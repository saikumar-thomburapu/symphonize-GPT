...
#             # ✅ FIXED: Removed JSX comments, pure HTML
#             html_body = f"""
#             <html>
...
#                             <h1 style="color: #3e78c2; margin: 0;">Symphonize AI</h1>
#                             <p style="color: #999; margin: 5px 0 0 0;">Professional AI Chat Assistant</p>
#                         </div>
...
#                         <p>We received a request to reset your password for your Symphonize AI account. If you made this request, click the button below to create a new password:</p>
                        
#                         <!-- Reset Button -->
#                         <div style="text-align: center; margin: 30px 0;">
#                             <a href="{reset_link}" 
#                                style="background: linear-gradient(135deg, #3e78c2 0%, #66c5fb 100%); color: white; padding: 14px 40px; text-decoration: none; border-radius: 6px; display: inline-block; font-weight: bold; font-size: 16px;">
#                                 Reset Password
#                             </a>
#                         </div>
                        
#                         <p style="color: #666; background: #f9f9f9; padding: 15px; border-left: 4px solid #3e78c2; border-radius: 3px;">
#                             <strong>Or copy this link:</strong><br/>
#                             <code style="word-break: break-all; color: #3e78c2;">{reset_link}</code>
#                         </p>
...
#                                 <strong>⏰ This link expires in 1 hour</strong><br/>
#                                 For security reasons, this reset link is only valid for 1 hour. If it expires, request a new one.
#                             </p>
#                         </div>
